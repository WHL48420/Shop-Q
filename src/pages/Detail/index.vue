          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in spuSaleAttrList" :key="item.id">
                ...
                <dd
                  changepirce="0"
                  :class="{ active: items.isChecked == 1 }"
                  v-for="items in item.spuSaleAttrValueList"
                  :key="items.id"
                  @click="changeisChecked(items, item.spuSaleAttrValueList)"
                >
                  {{ items.saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                ...
                <a
                  href="javascript:"
                  class="mins"
                  @click="number <= 1 ? (number = 1) : number--"
                  >-</a
                >
              </div>
              <div class="add">
  ...
  methods: {
    ...
    async addshop() {
      ...
      try {
        ...
        //如果返回一个非空字符串ok   代表成功   如果返回一个reject  代表失败
        //成功巨跳转到加入购物车成功的组件
        this.$router.push({
          name: "AddCartSuccess",
